...
/* SISTEMAS (tarjetas debajo del texto de bienvenida): 6 sistemas del Excel, clicables */
.ods-insight-stats {
  display: grid;
...
.swatch-soporte       { border-color: #4ade80; }
.swatch-conectividad  { border-color: #5b8def; }
.swatch-dependencia   { border-color: #f76fb0; border-top-style: dashed; }
.swatch-transformacion{ border-color: #a276f2; border-top-style: double; border-top-width: 3px; }

.swatch-eco        { border-color: #4ade80; }
.swatch-habitat     { border-color: #ef9552; }
.swatch-movilidad   { border-color: #5b8def; }
.swatch-economico   { border-color: #f5c945; }
.swatch-social      { border-color: #f76fb0; }
.swatch-gobernanza  { border-color: #a276f2; }
...
.ods-node { cursor: pointer; touch-action: none; }
...
.ods-node.node-off .node-ring { opacity: 0.14; }
.ods-node.node-off .node-inner { opacity: 0.22; }
...
.ods-edge.edge-visual-double path { transition: opacity .15s, filter .15s; }
.ods-edge.edge-hit { fill: none; stroke: transparent; stroke-width: 10; pointer-events: stroke; }

.edge-group:hover .edge-visual,
.edge-group:hover .edge-visual path {
  opacity: 1 !important;
  filter: drop-shadow(0 0 4px var(--edge-color));
}

.edge-group.edge-selected .edge-visual,
.edge-group.edge-selected .edge-visual path {
  opacity: 1 !important;
...
.matrix-row.highlight {
  ...
  box-shadow: 0 0 0 1px rgba(47,212,200,0.4) inset;
}
...
.alignment-tag.dep {
  background: rgba(247,111,176,0.15);
  color: #f76fb0;
}

.alignment-tag.trans {
  background: rgba(162,118,242,0.15);
  color: #a276f2;
}

.matrix-row.row-highlight {
  background: rgba(47,212,200,0.08);
  box-shadow: inset 0 0 0 1.5px rgba(47,212,200,0.45);
}
...
.synergy-card.success {
  background: linear-gradient(135deg, rgba(74,222,128,0.08), rgba(74,222,128,0.02));
  border-color: rgba(74,222,128,0.2);
}

.synergy-card.conflict {
  background: linear-gradient(135deg, rgba(247,111,176,0.08), rgba(247,111,176,0.02));
  border-color: rgba(247,111,176,0.2);
}
...
.synergy-card.success .synergy-icon {
  background: rgba(74,222,128,0.15);
  color: var(--green);
}

.synergy-card.conflict .synergy-icon {
  background: rgba(247,111,176,0.15);
  color: var(--pink);
}
...
.btn-primary {
  background: linear-gradient(135deg, var(--teal), #22b3a8);
  color: #06110f;
}
...
/* BUILDER SECTION — Constructor de modelo */
.builder-section {
  margin-bottom: 28px;
}
...
@media (max-width: 1300px) {
  .ods-insight-stats { grid-template-columns: repeat(3, 1fr); }
}
