...
const POT_DATA = {
  ...
  EIP: [
    ...
    { origen: "Patrimonio arqueológico", destino: "Patrimonio natural", tipo: "Resiliencia", sustento: "Hoy pueden ser referentes de procesos adaptativos y que revelan prácticas de integralidad de la cultura con la naturaleza.", page: "p. 198" },
    { origen: "Patrimonio arqueológico", destino: "Patrimonio material", tipo: "Soporte", sustento: "Este patrimonio cultural se convirtió en un referente de movilización.", page: "p. 198" },
    { origen: "Sistema de Sitios Sagrados", destino: "Patrimonio inmaterial", tipo: "Soporte", sustento: "Son el testimonio de complejas estrategias de cómo interpretamos y valoramos las huellas del territorio que…", page: "p. 186" }
  ]
};
